function [Time,I,V] = importCVRint(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [TIME,I1,V1] = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   [TIME,I1,V1] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [Time,I1,V1] = importfile('10-CV-5V-100nArange.txt',2, 3001);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/07/05 15:15:45
