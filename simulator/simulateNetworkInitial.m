function [OutputDynamics, SimulationOptions, snapshots] = simulateNetworkInitial(Equations, Components, Stimulus, SimulationOptions, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for ii = 1 : niterations
        ...
        testerVoltage(ii,:) = V(end)*Stimulus.Signal(ii);
