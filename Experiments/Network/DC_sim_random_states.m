function DC_sim_random_states(seed, saveFolder, amp, useRect, rescalePLength, Connectivity, T)
%{
    ...
    DC_sim_random_states(1, '.',  1.05, true, true, struct('WhichMatrix', 'WattsStrogatz', 'beta', 0.0,...
