function snapshotFigure = snapshotToFigureLyapunov(snapshot, contacts, connectivity, whatToPlot, axesLimits, highlightNodes, highlightEdges)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%}
    ...
    if whatToPlot.GraphRep
        ...
        elseif whatToPlot.Lambda
            ...
            cbar  = colorbar;
            cbar.Label.String = 'junction lyapunov (s^{-1})';
