	...
	switch sims{1}.Stim.BiasType
        case {'DC', 'DCandWait'}
            ...
            for i = 1:numel(sims)
                ...
                s.eqTimes(i) = tvec(1 + find(sum(abs(sims{i}.swLam(2:end,:) - sims{i}.swLam(1:end - 1,:)), 2) == 0, 1));
