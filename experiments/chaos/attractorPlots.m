function attractorPlots(saveFolder)
    ...
    parfor i = 1:numel(t)
        ...
        saveas(gcf, strcat('images/IV_A', num2str(t{i}.Stim.Amplitude), '_f', num2str(t{i}.Stim.Frequency), '_b', num2str(t{i}.Comp.boost), '.png'))
        close all;
    end
