function DC_vary_nets_threshold(idx, netFolder, saveFolder, ensembleID, Vidx, EventThreshold) 
 %{
...
%             assert(N == numel(files));
    ...
    saveF1 = strcat(saveFolder, '/Vstar', num2str(Vstar(Vidx)), '/EventThreshold', num2str(EventThreshold), '/seed', num2str(seedIdx - 1,'%03.f'), '/');
