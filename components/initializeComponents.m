...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    switch Components.ComponentType
        ...
        case 'atomicSwitch'
            ...
            Components.setVoltage    = ones(E+1,1)*1e-2;    % (Volt)
            Components.resetVoltage  = ones(E+1,1)*1e-3;    % (Volt)
            Components.criticalFlux  = ones(E+1,1)*1e-1;    % (Volt*sec) 
            Components.maxFlux       = ones(E+1,1)*0.15;  % (Volt*sec)
        case 'resistor'
